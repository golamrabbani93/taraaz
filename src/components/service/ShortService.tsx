...
function ComponentName() {
	...
	return (
		<div>
			<div className="rts-shorts-service-area rts-section-gap bg_primary d-none">
					...
					<div className="row g-5">
						<div className="col-lg-3 col-md-6 col-sm-12 col-12">
							...
							<div className="single-short-service-area-start">
								...
								<div className="information">
									<h4 className="title">
										{language === 'en' ? 'Best Prices & Offers' : 'সেরা মূল্য এবং অফার'}
									</h4>
									<p className="disc">
										{language === 'en'
											? 'We prepared special discounts you on zafran products.'
											: 'আমরা আপনার জন্য জাফরান পণ্যের উপর বিশেষ ছাড়ের ব্যবস্থা করেছি।'}
									</p>
								</div>
							</div>
						...
						<div className="col-lg-3 col-md-6 col-sm-12 col-12">
							...
							<div className="single-short-service-area-start">
								...
								<div className="information">
									<h4 className="title">
										{language === 'en' ? '100% Return Policy' : '১০০% রিটার্ন পলিসি'}
									</h4>
									<p className="disc">
										{language === 'en'
											? 'Enjoy peace of mind with 100% return assurance on all Zafran products.'
											: 'সমস্ত জাফরান পণ্যে ১০০% রিটার্নের নিশ্চয়তা সহ মানসিক প্রশান্তি উপভোগ করুন।'}
									</p>
								</div>
							</div>
							{/* single service area end */}
						...
						<div className="col-lg-3 col-md-6 col-sm-12 col-12">
							...
							<div className="single-short-service-area-start">
								...
								<div className="information">
									<h4 className="title">{language === 'en' ? 'Support 24/7' : '২৪/৭ সহায়তা'}</h4>
									<p className="disc">
										{language === 'en'
											? 'Enjoy nonstop support and special deals on Zafran products.'
											: 'জাফরান পণ্যের উপর বিরামহীন সমর্থন এবং বিশেষ ডিল উপভোগ করুন।'}
									</p>
								</div>
							</div>
							{/* single service area end */}
						...
						<div className="col-lg-3 col-md-6 col-sm-12 col-12">
							...
							<div className="single-short-service-area-start">
								...
								<div className="information">
									<h4 className="title">
										{language === 'en' ? 'Great Daily Deals' : 'দৈনিক দুর্দান্ত ডিল'}
									</h4>
									<p className="disc">
										{language === 'en'
											? 'Shop daily and save big with exciting Zafran discounts.'
											: 'প্রতিদিন শপিং করুন এবং জাফরান ডিসকাউন্টের সাথে বড় সঞ্চয় করুন।'}
									</p>
								</div>
							</div>
							{/* single service area end */}
