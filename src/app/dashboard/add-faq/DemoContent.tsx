...
import {useCreateFAQMutation} from '@/redux/features/faq/faqManagementApi';
...
const AddProductPage = () => {
	...
	const handleSubmit = async (data: FieldValues) => {
		...
		catchAsync(async () => {
			...
			setRows([{id: 1, question: '', b_question: '', answer: '', b_answer: ''}]);
			if (result) {
				router.push('/dashboard/faq-list');
			} else {
					...
					<div className="card-body table-product-select">
						<div className="header-two show right-collups-add-product">
							...
							<div className="input-main-wrapper">
								<ZForm onSubmit={handleSubmit} resolver={zodResolver(faqSchema)}>
									<div className="row">
