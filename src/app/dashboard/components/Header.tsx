...
export default function Header({onToggleSidebar}: HeaderProps) {
	const [user, setUser] = useState<ReturnType<typeof selectUser> | null>(null);
		...
		<header className="header-one">
			...
			<div className="header-right">
				<Link href="/" target="_blank">
					<button
						className="btn btn-primary rounded-30 logout-button me-4"
						style={{width: '100px', height: '36px', fontSize: '18px'}}
					>
						Home
				...
				<button
					className="btn btn-danger rounded-30 logout-button"
					style={{width: '100px', height: '36px', fontSize: '18px'}}
										...
										<li className="single__items" key={item.id}>
											<a className="single-link" href="#">
												<div className="avatar">
													<Image src={item.avatar} alt="User" width={40} height={40} />
												</div>
				...
				{/* <div
					...
					>
						<div className="avatar">
							<Image
								src="/assets/images-dashboard/icons/05.svg"
								alt="User Avatar"
								width={20}
								height={20}
							/>
						...
						>
							<div className="user_header">
								<div className="main-avatar">
									<Image src="/assets/images/avatar/user-2.svg" alt="User" width={60} height={60} />
								</div>
								<div className="user_naim-information">
									<h3 className="title">{user?.name ?? 'User Name'}</h3>
									<span className="desig">{user?.role ?? ''}</span>
								</div>
							</div>
				...
				{/* <div className="popup-footer-btn mt-5">
								<span className="geex-content__header__popup__footer__link ">
									Logout
									<i className="fa-light fa-arrow-right" />
								</span>
							</div>
